	...
	<div class="container mt-5 ">
		...
		<form action="edit_act.php" method="post" enctype="multipart/form-data">
			...
			<div class="mb-3">
				...
				<input type="text" name="email" class="form-control" value="<?php echo $row['siswa_email']; ?>">
			</div>
			<div class="mb-3">
				<label class="form-label">Jurusan</label>
				<input type="text" name="jurusan" class="form-control" value="<?php echo $row['siswa_jurusan']; ?>">
			</div>
			<div class="mb-3">
				<label class="form-label">Fakultas</label>
				<input type="text" name="fakultas" class="form-control" value="<?php echo $row['siswa_fakultas']; ?>">
			</div>
			<div class="mb-3">
				...
				<br>
				<?php 
				if ($row['siswa_foto'] == "depry.jpg") { ?>
					<img src="depry.jpg" style="width:100px;height:100px;">
				<?php }else{ ?>
