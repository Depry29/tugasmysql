...
if ($foto_size > 2097152) {
	...
	if ($foto_nama != "") {
		...
		if(in_array($ekstensi, $ekstensi_izin) === true)  {
            ...
            $query = mysqli_query($koneksi, "INSERT INTO siswa VALUES ('','$nama_lengkap', '$email', '$jurusan','$fakultas', '$foto_nama_new')");
    	...
    	// Apabila tidak ada file yang diupload maka akan menjalankan code dibawah ini
    	 $query = mysqli_query($koneksi, "INSERT INTO siswa(siswa_nama, siswa_email, siswa_jurusan, siswa_fakultas) VALUES ('$nama_lengkap', '$email', '$jurusan', '$fakultas')");
